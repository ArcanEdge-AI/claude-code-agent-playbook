...
description: Use when a coding task may benefit from Claude Code subagents for planning, engineering, review, testing, or documentation lookup. Helps the main agent delegate bounded work and verify outputs before accepting them.
---
...
3. Choose from the Claude Code roles: Planner, Engineer, Reviewer, Tester, and Docs.
